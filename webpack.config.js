...
let entry = "./weatherApp/js/weather.jsx";
if (existsSync("./weatherApp/js/weather.tsx")) {
  entry = "./weatherApp/js/weatherApp.tsx";
}
...
module.exports = {
  ...
  entry,
  output: {
    path: path.join(__dirname, "/weatherApp/static/js/"),
    filename: "bundle.js",
  },
  devtool: "source-map",
  module: {
